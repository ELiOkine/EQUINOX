...
<body>
	...
	<br>
		...
		<?php
			if (isset($_POST['add']))
				...
				$q2 = mysqli_query($conn, "INSERT INTO stock ( car_id, quantity) VALUES ('$car_code','$qty')");
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			...
			<form method="post" class="well"  style=" overflow:hidden;">
	<div id="printablediv">
	<center> 
	<table class="table" style="width:50%;">
	<label style="font-size:25px;">EQUINOX INCORPORATED</label>
