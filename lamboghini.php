...
<div id="container">
	...
	<div class="nav">
			 ...
			 <ul>
				...
				<li><a href="cars.php"><i class="icon-th-list"></i>Cars</a>
		...
		<div class="nav1">
			<ul>
				<li><a href="cars.php">PORSCHE</a></li>
				<li>|</li>
				<li><a href="lamboghini.php" class= "active" style="color:#111;">LAMBOGHINI</a></li>
				<li>|</li>
	...
	<div id="content">
        ...
        <?php 
				...
				$query = mysqli_query($conn, "SELECT * FROM car WHERE brand = 'lamboghini' ORDER BY car_id DESC") or die(mysqli_connect_error($conn));
