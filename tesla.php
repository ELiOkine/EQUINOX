...
<div id="container">
    ...
    <ul>
		...
		<div class="nav1">
			<ul>
				...
				<li>|</li>
				<li><a href="tesla.php" class="active" style="color:#111;" >TESLA</a></li>
			</ul>
	...
	<div id="content">
        ...
        <?php 
				...
				$query = mysqli_query($conn, "SELECT * FROM car WHERE brand = 'tesla' ORDER BY car_id DESC") or die(mysqli_connect_error($conn));
